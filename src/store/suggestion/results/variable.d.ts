...
export declare function filterResults(kind: VarSuggestionKinds, search: string, dispatch: Dispatch, getState: () => State, callback: (results: VariableResult[]) => void): void;
export {};
