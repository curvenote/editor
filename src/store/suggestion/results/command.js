...
export function executeCommand(command, viewOrId, removeText, replace) {
    ...
    return function (dispatch, getState) { return __awaiter(_this, void 0, void 0, function () {
        var view, ev, schema, replaceOrInsert, _a, _b, empty, $from, $to, content, tr, href, Table, Row, header, cell, figure, tr, linkBounds, from_1, to_1, href, _c, from, to, name_1, name_2, name_3, url, id, src, url, id, src, url, id, src, url, id, src, src, cites, nodes, wrapped, tr;
        var _d, _e, _f;
            ...
            switch (_g.label) {
                case 0:
                    ...
                    switch (_a) {
                        ...
                        case CommandNames.link_block: return [3, 3];
                        case CommandNames.insert_table: return [3, 4];
                        case CommandNames.link: return [3, 5];
                        case CommandNames.callout: return [3, 6];
                        case CommandNames.aside: return [3, 7];
                        case CommandNames.horizontal_rule: return [3, 8];
                        case CommandNames.paragraph: return [3, 9];
                        case CommandNames.heading1: return [3, 10];
                        case CommandNames.heading2: return [3, 10];
                        case CommandNames.heading3: return [3, 10];
                        case CommandNames.heading4: return [3, 10];
                        case CommandNames.heading5: return [3, 10];
                        case CommandNames.heading6: return [3, 10];
                        case CommandNames.quote: return [3, 11];
                        case CommandNames.time: return [3, 12];
                        case CommandNames.bullet_list: return [3, 13];
                        case CommandNames.ordered_list: return [3, 14];
                        case CommandNames.emoji: return [3, 15];
                        case CommandNames.math: return [3, 16];
                        case CommandNames.equation: return [3, 17];
                        case CommandNames.code: return [3, 18];
                        case CommandNames.variable: return [3, 19];
                        case CommandNames.display: return [3, 20];
                        case CommandNames.range: return [3, 21];
                        case CommandNames.dynamic: return [3, 22];
                        case CommandNames.switch: return [3, 23];
                        case CommandNames.button: return [3, 24];
                        case CommandNames.youtube: return [3, 25];
                        case CommandNames.loom: return [3, 26];
                        case CommandNames.vimeo: return [3, 27];
                        case CommandNames.miro: return [3, 28];
                        case CommandNames.iframe: return [3, 29];
                        case CommandNames.link_section: return [3, 30];
                        case CommandNames.link_figure: return [3, 31];
                        case CommandNames.link_equation: return [3, 32];
                        case CommandNames.link_code: return [3, 33];
                        case CommandNames.link_article: return [3, 34];
                        case CommandNames.link_table: return [3, 35];
                        case CommandNames.link_notebook: return [3, 36];
                        case CommandNames.citation: return [3, 37];
                        case CommandNames.add_citation: return [3, 38];
                    }
                    return [3, 40];
                case 1:
                    {
