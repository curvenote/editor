export var SELECT_EDITOR_VIEW = 'SELECT_EDITOR_VIEW';
export var FOCUS_EDITOR_VIEW = 'FOCUS_EDITOR_VIEW';
export var INLINE_SELECTION = 'INLINE_SELECTION';
...
(function (SelectionKinds) {
    ...
    SelectionKinds["equation"] = "equation";
    SelectionKinds["cite"] = "cite";
    SelectionKinds["citegroup"] = "citegroup";
