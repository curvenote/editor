...
export declare const wrapInHeading: (level: number) => import("redux-thunk").ThunkAction<boolean, import("../types").State, null, import("redux").Action<string>>;
export declare const insertVariable: (attrs?: Nodes.Variable.Attrs) => import("redux-thunk").ThunkAction<boolean, import("../types").State, null, import("redux").Action<string>>;
