...
var CiteView = (function () {
    function CiteView(node, view, getPos) {
        ...
        var key = node.attrs.key;
        var onDelete = function () {
            var tr = _this.view.state.tr.delete(_this.getPos(), _this.getPos() + 1);
            _this.view.dispatch(tr);
        };
        render(React.createElement(CiteEditor, __assign({}, { onDelete: onDelete }, { ref: function (r) { _this.editor = r; } })), this.dom, function () { return __awaiter(_this, void 0, void 0, function () {
            var _a;
    ...
    CiteView.prototype.selectNode = function () {
        var _a;
        var viewId = this.view.dom.id;
    ...
    CiteView.prototype.deselectNode = function () {
        var _a;
        var edit = isEditable(this.view.state);
        (_a = this.editor) === null || _a === void 0 ? void 0 : _a.setState({ open: false, edit: edit });
    };
    CiteView.prototype.update = function (node) {
        var _a;
        ...
        var edit = isEditable(this.view.state);
        var key = node.attrs.key;
        (_a = this.editor) === null || _a === void 0 ? void 0 : _a.setState({ edit: edit, uid: key });
        return true;
    };
    CiteView.prototype.destroy = function () {
    };
    return CiteView;
}());
