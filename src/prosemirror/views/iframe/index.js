...
var IFrameView = (function () {
    function IFrameView(node, view, getPos) {
        var _this = this;
        this.editor = null;
        this.node = node;
        this.view = view;
        ...
        var _a = node.attrs, src = _a.src, align = _a.align, width = _a.width;
        this.currentSrc = src;
    ...
    IFrameView.prototype.selectNode = function () {
        var _a;
        var viewId = this.view.dom.id;
    ...
    IFrameView.prototype.deselectNode = function () {
        var _a;
        var edit = isEditable(this.view.state);
        (_a = this.editor) === null || _a === void 0 ? void 0 : _a.setState({ open: false, edit: edit });
    };
    IFrameView.prototype.update = function (node) {
        var _a;
        if (!node.sameMarkup(this.node))
            return false;
        this.node = node;
        var edit = isEditable(this.view.state);
        var _b = node.attrs, src = _b.src, align = _b.align, width = _b.width;
        if (src !== this.currentSrc) {
            console.log('Source change?');
        }
        (_a = this.editor) === null || _a === void 0 ? void 0 : _a.setState({
            edit: edit, align: align, width: width,
        });
        return true;
    };
