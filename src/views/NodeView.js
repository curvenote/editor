...
var ClassWrapper = (function (_super) {
    __extends(ClassWrapper, _super);
    ...
    ClassWrapper.prototype.render = function () {
...
var ReactWrapper = (function () {
    function ReactWrapper(NodeView, nodeViewPos, options) {
        var _this = this;
        this.editor = null;
        var node = nodeViewPos.node, view = nodeViewPos.view, getPos = nodeViewPos.getPos;
        this.node = node;
        this.view = view;
        this.getPos = getPos;
