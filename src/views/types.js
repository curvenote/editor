...
(function (LanguageNames) {
    ...
    LanguageNames["ObjC"] = "text/x-objectivec";
    LanguageNames["Java"] = "text/x-java";
    LanguageNames["Scala"] = "text/x-scala";
    LanguageNames["C"] = "text/x-csrc";
    LanguageNames["Csharp"] = "text/x-csharp";
    LanguageNames["Julia"] = "julia";
    LanguageNames["Html"] = "htmlmixed";
    LanguageNames["R"] = "r";
    LanguageNames["Sql"] = "sql";
