...
var InlineActionSwitch = function () {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        kind === Kinds.image && React.createElement(AlignActions, __assign({ showCaption: true }, { stateId: stateId, viewId: viewId })),
        kind === Kinds.iframe && React.createElement(AlignActions, __assign({}, { stateId: stateId, viewId: viewId })),
